  ...
  return (
    <Box mt={129}>
      ...
      <Typography mdFontSize={18} mt={24} fontSize={24} lineHeight={28} align="justify">
        In projects with ERC-20 tokens like $BERRIES, utilities are necessary mechanisms to consume or "burn" the tokens
        that are generated over time. This gives them additional value and helps stabilize the market price of the
        token. <br /> <br /> The MetaBears team is committed to making sure there are sufficient utilities for using
        $BERRIES you accumulate from staking or by direct purchase. Our first major time-limited utility event will be
        Heaven and Hell launching November 11th. This event will allow holders to spend their $BERRIES for an exclusive
